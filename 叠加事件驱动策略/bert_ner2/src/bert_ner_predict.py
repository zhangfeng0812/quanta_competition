...
# label_list = ["O", "B-TIME", "I-TIME", "B-PER", "I-PER", "B-ORG", "I-ORG", "B-LOC", "I-LOC", "X","[CLS]","[SEP]"]
label_list = ["O", "B-STOCK","B-CONCEPT","B-INDEX","B-GOODS","B-ORG","B-PER","B-ACT","B-OCC","B-RAT","B-TIME","B-SOU","B-LOC","I-STOCK","I-CONCEPT","I-INDEX","I-GOODS","I-ORG","I-PER","I-ACT","I-OCC","I-RAT","I-TIME","I-SOU","I-LOC","X", "[CLS]", "[SEP]"]
...
class Result(object):
    ...
    def append(self, word, start, end, tag):
        if tag == 'LOCATION':
            ...
            self.time.append(Pair(word, start, end, 'STOCK'))
        else:
