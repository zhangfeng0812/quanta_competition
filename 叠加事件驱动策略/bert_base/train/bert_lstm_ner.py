    ...
    def get_labels(self, labels=None):
        ...
        if os.path.exists(os.path.join(self.output_dir, 'label_list.pkl')):
            ...
            if len(self.labels) > 0:
                ...
                #self.labels = ["O","B-TIME", "I-TIME", "B-PER", "I-PER", "B-ORG", "I-ORG", "B-LOC", "I-LOC", "X","[CLS]","[SEP]"]
                 self.labels = ["O", "B-STOCK", "B-CONCEPT", "B-INDEX", "B-GOODS", "B-ORG", "B-PER", "B-ACT", "B-OCC",
                              "B-RAT", "B-TIME", "B-SOU", "B-LOC", "I-STOCK", "I-CONCEPT", "I-INDEX",
                             "I-GOODS", "I-ORG", "I-PER", "I-ACT", "I-OCC", "I-RAT", "I-TIME", "I-SOU", "I-LOC",
                              "X", "[CLS]", "[SEP]"]
        return self.labels
...
def train(args):
    ...
    if args.do_train and args.do_eval:
        ...
        # early stop hook
        early_stopping_hook = tensorflow.estimator.experimental.stop_if_no_decrease_hook(
            estimator=estimator,
            metric_name='loss',
