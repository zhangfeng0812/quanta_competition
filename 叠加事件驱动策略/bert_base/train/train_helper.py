...
def get_args_parser():
    ...
    # windows下的路径表示
    if os.name == 'nt':
        bert_path = r'E:\nlp_data\chinese_L-12_H-768_A-12'
        root_path = r'E:\app\projects\bert_ner'
    ...
    group1.add_argument('-model_path', type=str, default=os.path.join(root_path, 'output2'),
                        help='trained BERT model')
    group1.add_argument('-data_dir', type=str, default=os.path.join(root_path, 'NERdata2'),
